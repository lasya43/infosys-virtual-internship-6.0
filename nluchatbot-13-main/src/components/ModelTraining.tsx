...
const ModelTraining = ({ workspaceId, userId }: ModelTrainingProps) => {
  ...
  const [modelType, setModelType] = useState<string>("spacy");
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
              {[
                ...
                { id: "roberta", name: "RoBERTa" },
                { id: "albert", name: "ALBERT" },
                { id: "xlm-roberta", name: "XLM-RoBERTa" },
                { id: "deberta", name: "DeBERTa" },
                { id: "t5", name: "T5" },
                { id: "gpt2", name: "GPT-2" }
              ].map((type) => (
                <button
                ...
                >
                  <Brain className="h-6 w-6 mb-2 text-primary mx-auto" />
